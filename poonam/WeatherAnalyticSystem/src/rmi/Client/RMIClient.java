...
public class RMIClient {
	...
	public static String fetchAllDaily() {
		String status = "";
		try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			WeatherImpl obj = (WeatherImpl) Naming.lookup("Get_Data"); // looking
																		// for
																		// objectname
																		// in
																		// registry
			...
			System.out.println("--------------------------------------------");
			String result = obj.getData(91722); // get the hard coded zip value
												// from UI
